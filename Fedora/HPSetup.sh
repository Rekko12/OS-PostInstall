...
hostnamectl set-hostname HP830G5
...
dnf install -y btop inxi fastfetch unzip unrar git wget curl man-pages tldr libimobiledevice
...
color_echo "yellow" "Removing GNOME Apps"
dnf remove gnome-contacts gnome-weather gnome-maps showtime snapshot decibels gnome-connections gnome-font-viewer gnome-tour gnome-text-editor firefox -y
